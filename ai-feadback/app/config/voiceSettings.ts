...
export const CHARACTER_OPTIONS = [
  { id: SPEAKER_IDS.ZUNDAMON, name: 'ずんだもん', bg: 'bg-gradient-to-br from-green-150 via-emerald-100 to-teal-100', accent: 'bg-green-100 border-green-300', color: 'green', bgButton: 'bg-green-400', textColor: 'text-green-400'},
